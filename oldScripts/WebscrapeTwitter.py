...
for k,v in search.items():
    ...
    # Saving all the results for this country into text file

    key = k.replace(' ','_') # removing any spaces in key string

    with open(r'C:\Users\12shu\OneDrive - Kubrick Group\upskill\tweets_{}.txt'.format(key),'wb') as f:
        for t in temp:                 
